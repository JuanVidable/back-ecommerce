...
/*
    ...
    CommandLineRunner init(ClienteRepository clienteRepository,
        ...
        return args -> {
            ...
            StockInsumoSucursal stockTomateSuc2 = StockInsumoSucursal.builder().stockActual(16).stockMinimo(10).stockMaximo(40).articuloInsumo(tomate).sucursal(mama1).build();
            StockInsumoSucursal stockHarinaSuc2 = StockInsumoSucursal.builder().stockActual(1200).stockMinimo(500).stockMaximo(4000).articuloInsumo(harina).sucursal(mama1).build();
            StockInsumoSucursal stockQuesoSuc2 = StockInsumoSucursal.builder().stockActual(3000).stockMinimo(1000).stockMaximo(4000).articuloInsumo(queso).sucursal(mama1).build();
            StockInsumoSucursal stockCervezaSuc2 = StockInsumoSucursal.builder().stockActual(30).stockMinimo(10).stockMaximo(70).articuloInsumo(cerveza).sucursal(mama1).build();
            ...
            harina.getStocksInsumo().add(stockHarinaSuc2);

            queso.getStocksInsumo().add(stockQuesoSuc2);
            tomate.getStocksInsumo().add(stockTomateSuc1);
            tomate.getStocksInsumo().add(stockTomateSuc2);
            cerveza.getStocksInsumo().add(stockCervezaSuc1);
            cerveza.getStocksInsumo().add(stockCervezaSuc2);
            ...
            pizzaConCoca.getSucursales().add(mama1);
            pizzaConCoca.getSucursales().add(mama2);
            mama1.getPromociones().add(pizzaConCoca);
            mama2.getPromociones().add(pizzaConCoca);
...
//			empleado.setUsuarioCliente(usuarioEmpleado);
            ...
            empleado.setSucursal(massa1);
            massa1.getEmpleados().add(empleado);
